...
def create_model(train=True):
    ...
    dropout_1 = Dropout(0.3, name='char_dropout_1')(embed_chars_1)
    ...
    # char_enc = TimeDistributed(LSTM(units=20, return_sequences=False, recurrent_dropout=0.5))(embed_chars)
    dropout_2 = Dropout(0.3, name='char_dropout_2')(embed_chars_2)
    ...
    # char_enc = TimeDistributed(LSTM(units=20, return_sequences=False, recurrent_dropout=0.5))(embed_chars)
    dropout_3 = Dropout(0.3, name='char_dropout_3')(embed_chars_3)
